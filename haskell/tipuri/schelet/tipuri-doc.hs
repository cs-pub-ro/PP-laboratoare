...
{-
  newtype poate fi parametrizat, însă constructorul său primește
...
{-
  ...
  funcțiilor de extracție a datelor definite ca și
  câmpuri ale tipului.
-}
...
{-
  ...
  sau Nothing în caz contrar. De reținut: a este o variabila de tip
...
{-
  ...
  În cazul în care se trimite o listă vidă va eșua, întrucât tipul nu
...
{-
  Tipul de date TList reprezintă tipul listă reprezentativ
