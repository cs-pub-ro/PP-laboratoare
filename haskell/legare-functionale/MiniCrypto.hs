...
{-
  0. (0p)
  Pentru a face pointfree functiile puteti sa va folositi de functia flip'.
  Care intoarce ordinea parametrilor functiei care primeste 2 parametrii.
-}
flip' :: (a -> b -> c) -> b -> a -> c 
flip' f x y = f y x
...
test9 = tests 9 1
  [ testVal
    ...
    "xorStrings 1" 0.5
  , testVal
    (xorStrings (xorStrings "theturtlemoves" "cccccaaaaaabbb"))
    "theturtlemoves"
    "xorStrings 2" 0.5
  ]
{- 10, (Bonus - 1p)
