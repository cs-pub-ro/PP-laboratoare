...
\node [mybox_skyblue] (box){%
    \begin{minipage}{0.3\textwidth}\centering
{\centering\bf\color{blue!60} image-height, overlay, flip-vertical \\}
\begin{lstlisting}[language=Racket,escapeinside=||]
(overlay |\includegraphics[scale=0.5]{imgs/fig1.png}|) ; => |\includegraphics[scale=0.5]{imgs/fig2.png}|
(flip-vertical |\includegraphics[scale=0.5]{imgs/fig3.png}|) ; => |\includegraphics[scale=0.5]{imgs/fig4.png}|
(image-height (circle 20 "solid" "red")) ; => 40
(image-height |\includegraphics[scale=0.5]{imgs/fig0.png}|) ; => 60
\end{lstlisting}
    \end{minipage}
};
